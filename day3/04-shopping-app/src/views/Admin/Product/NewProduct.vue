        ...
        <div class="col-6 offset-3 p-0 card">
          ...
          <div class="card-body">
            <div class="mb-3">
              ...
              <input type="text" v-model="userData.productName" class="form-control" id="productName" placeholder="ürünün adını giriniz..." />
            </div>
            <div class="mb-3">
              <label for="price" class="form-label">Ürünün Fiyatı</label>
              <input type="text"  v-model="userData.price" class="form-control" id="price" placeholder="ürünün fiyatını giriniz..." />
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
              ...
              <textarea v-model="userData.descriptionArea" class="form-control" id="descriptionArea" rows="3"></textarea>
            </div>
...
export default {
    ...
    methods : {
        onSave(){
            ...
            this.$axios.post("http://localhost:3000/products",this.userData).then(save_response => {
